...
public class Utils {
    ...
    public static Plugin plugin = Main.getProvidingPlugin(Main.class);
    ...
    public static void fireBeam(Player player, Location from, Location to, Color color, double range, double damageDealt) {
    ...
    public static LivingEntity getNearestLivingEntity(Location location, ArrayList<EntityType> ignoreType, ArrayList<Entity> ignore) {
        ...
        for (Entity entity : nearbyEntites) {
            ...
            if (ignoreType.contains(entity.getType())) {
                continue;
            }
            if (entity instanceof LivingEntity) {
